  ...
  const projects: Project[] = [
    {
      title: "Kurirlink",
      description:
        "KurirLink is a web-based platform that I developed end-to-end to help shipping agents manage and send packages more efficiently. It features a membership system, a dynamic package submission form, a balance top-up system integrated with a payment gateway, a help ticket module for customer support, and a Cash on Delivery (COD) request system. This project aims to provide a seamless and fully integrated digital experience for delivery agents.",
      image: "kurirlink",
      linkCode: "",
      linkWeb: "https://kurirlink.stagin.web.id",
      tech: [
        ...
        "https://img.shields.io/badge/Hono.js-262626?style=flat-square&logo=cloudflare&logoColor=orange",
    ...
    },
    {
      title: "Juragan Paket",
      description:
        "Juragan Paket is a web platform I developed end-to-end to assist users—particularly small business owners—in managing their package deliveries digitally. I implemented core features such as a dynamic package delivery form, a balance top-up system integrated with a payment gateway, and a help ticket system to handle user inquiries or issues. Juragan Paket aims to streamline the shipping process in one centralized and user-friendly platform.",
      image: "juraganpaket",
      linkCode: "",
      linkWeb: "https://juraganpaket.id",
      tech: [
        "https://img.shields.io/badge/TypeScript-007ACC?style=flat-square&logo=typescript&logoColor=white",
        "https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white",
        "https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white",
    ...
    },
    {
      ...
      description:
        "Klinik Smartphone is an interactive landing page designed to introduce smartphone repair services to potential customers. This landing page displays important information such as types of repair services, customer testimonials, and options to contact customer service.",
      image: "klinik",
    ...
    },
    {
      ...
      description:
        "SaldaQ is a personal finance management application designed to help users easily track expenses, income, and financial categories. The application allows users to monitor balances, group transactions by category, and manage finances effectively.",
